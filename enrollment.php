                ...
                <form action="" id="enrollment-form">
                    ...
                    <fieldset>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="address" class="control-label">Address <small><span class="text-muted">(City, Province)</span></small></label>
                                    <textarea rows="1" name="address" id="address" class="form-control form-control-border border-navy" placeholder="City, District, Province, Zip Code" required></textarea>
                                </div>
                            </div>
                        </div>
                    </fieldset>
